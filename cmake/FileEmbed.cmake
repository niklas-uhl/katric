function(FileEmbedSetup)
    ...
    if (NOT EXISTS ${CMAKE_BINARY_DIR}/file_embed/file_embed_empty.cpp)
        file(WRITE ${CMAKE_BINARY_DIR}/file_embed/file_embed_empty.cpp "")
    endif ()

    add_library(file_embed ${CMAKE_BINARY_DIR}/file_embed/file_embed_empty.cpp)
...
extern unsigned ${c_name}_size\;
    ...
    file(WRITE ${CMAKE_BINARY_DIR}/file_embed/${c_name}.cpp
            ${output_c})

    file(WRITE ${CMAKE_BINARY_DIR}/file_embed/${c_name}.h
            ${output_h})

    set(${generated_c} ${CMAKE_BINARY_DIR}/file_embed/${c_name}.cpp PARENT_SCOPE)
