...
public:
    ...
    static void sparse_all_to_all(const google::dense_hash_map<PEID, std::vector<T>>& send_buffers,
                                  ...
                                  MPI_Datatype mpi_type, PEID rank, PEID size, cetric::profiling::MessageStatistics& stats, int message_tag) {
...
public:
    ...
    inline void add_message(const std::vector<T>& message, PEID recv, MessageFunc on_message, cetric::profiling::MessageStatistics& stats) {
    ...
    template<typename MessageFunc>
    inline void all_to_all(MessageFunc on_message, cetric::profiling::MessageStatistics& stats, bool full_all_to_all = false) {
        ...
        if (full_all_to_all) {
            ...
            CommunicationUtility::sparse_all_to_all(send_buffers_, recv_buffers_, mpi_type, rank_, size_, stats, message_tag_);
        }
